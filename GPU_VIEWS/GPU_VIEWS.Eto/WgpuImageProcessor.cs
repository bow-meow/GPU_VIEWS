...
{
    public class WgpuImageProcessor : IWgpuRenderer
    {
        ...
        public WgpuImageProcessor(WgpuView view)
        {
            ...
            _vertex_buffer_size = (ulong)(Marshal.SizeOf<Vertex>() * quad_vert.Length);
            _index_buffer_size = (ulong)(sizeof(int) * quad_index_map.Length);
