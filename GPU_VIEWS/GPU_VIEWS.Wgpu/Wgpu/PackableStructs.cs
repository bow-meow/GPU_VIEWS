...
namespace Wgpu
{
    ...
    public unsafe struct ComputePassTimestampWrites
    {
        ...
        public ComputePassTimestampWrites(QuerySetPtr querySet, uint? beginningOfPassWriteIndex = null, uint? endOfPassWriteIndex = null)
        {
            BeginningOfPassWriteIndex = beginningOfPassWriteIndex.HasValue ? beginningOfPassWriteIndex.Value : 0;
            EndOfPassWriteIndex = endOfPassWriteIndex.HasValue ? endOfPassWriteIndex.Value : 0;
            QuerySet = querySet;
        }

        internal Silk.NET.WebGPU.ComputePassTimestampWrites Pack()
        {
            return new Silk.NET.WebGPU.ComputePassTimestampWrites
            {
                QuerySet = QuerySet,
    ...
    public unsafe struct RenderPassTimestampWrites
    {
        ...
        public RenderPassTimestampWrites(QuerySetPtr querySet, uint? beginningOfPassWriteIndex = null, uint? endOfPassWriteIndex = null)
        {
            QuerySet = querySet;
        ...
        internal Silk.NET.WebGPU.RenderPassTimestampWrites Pack()
        {
            return new Silk.NET.WebGPU.RenderPassTimestampWrites
            {
                QuerySet = QuerySet,
                BeginningOfPassWriteIndex = BeginningOfPassWriteIndex,
                EndOfPassWriteIndex = EndOfPassWriteIndex
