...
namespace GPU_VIEWS.Wpf
{
	...
	/// </summary>
	public class ManualBubbleWindowsFormsHostHandler<TControl, TWidget, TCallback> : WpfFrameworkElement<WindowsFormsHostEx, TWidget, TCallback>
			...
			where TCallback : Control.ICallback
	{
		...
		{
			Control = new WindowsFormsHostEx();
		}
		...
		{
			var sysRect = new System.Drawing.Rectangle(rect.X, rect.Y, rect.Width, rect.Height);
			WinFormsControl.Invalidate(sysRect, invalidateChildren);
		}
